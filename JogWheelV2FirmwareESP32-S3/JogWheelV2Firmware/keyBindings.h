...
const byte defaultSwitchFunctions[] = {8,  8,  8, 68,  36,  36,  8,  8,  8,  8,  8,  8,  8,  4,  4,  4,  4,  4};//functions are bit feilds [alt,ctrl, shift, UnAssigned,normal,risingEdge,FallingEdge,UnAssigned]
